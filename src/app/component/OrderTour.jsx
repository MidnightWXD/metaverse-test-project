            ...
            <div className="flex justify-evenly my-[80px]">
                <div className="w-[620px] h-[556px] p-6 bg-white  rounded-[30px] shadow-[0_0px_23px_20px_rgba(0,0,0,0.03)]">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        <div className="p-6 bg-[#FFDAC0] rounded-[15px] w-[258px] h-[215px] relative">
                            <div className="w-[60px] h-[60px] bg-[#F47820] rounded-full flex items-center justify-center absolute -left-[15px] -top-[15px]">
                                <span className="text-white font-[600] text-[40px] leading-[60px]">1</span>
                            </div>
                            <div className="flex justify-center items-center w-full h-full">
                                <p className="text-center text-[25px] leading-[37.5px] font-[600] text-[#F47820]">Place your Order</p>
                            </div>
                        </div>
                        <div className="p-6 bg-[#F47820] text-white rounded-[15px] w-[258px] h-[215px] relative">
                        ...
                        <div className="w-[60px] h-[60px] bg-[#F47820] rounded-full flex items-center justify-center absolute -left-[15px] -top-[15px]">
                            ...
                            <div className="flex justify-center items-center w-full h-full">
                                <p className="text-center text-[25px] leading-[37.5px] font-[600] text-[#F47820]">Get Product to your Door Step</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="w-[620px] h-[556px] rounded-[30px] bg-[#FFDAC0] flex justify-center items-center pt-5">
                    <div className="w-[512px] h-[354px] relative bg-[url('/NorthAmericaMap.svg')] bg-no-repeat bg-contain bg-center rounded-[30px]">
                        ...
                        <div className="w-[512px] h-[354px] absolute top-0 left-0 bg-[#F47820] rounded-[30px] p-8 mix-blend-multiply">
            ...
            <div className="px-[80px]">
                <div className="w-full h-[158px] rounded-[30px] shadow-[0_4px_74px_25px_rgba(0,0,0,0.03)] flex justify-between items-center px-[50px]">
                    <div className="flex flex-col justify-center items-center">
                        ...
                        <h2 className="text-[20px] leading-[30px] font-[400] text-[#F47820]">Get weekly insights on new products and offers avialable</h2>
                    </div>
                    <div className="rounded-[15px] w-[430px] h-[66px] border border-solid border-[#F47820] p-2 flex justify-between">
